...
import app.quranhub.core.data.model.MyNoteModel
import app.quranhub.core.data.model.PageSuras
...
interface AyaDao {
    ...
    suspend fun getSuraJuzSearchResult(
        inputSearch: String?,
        selectedSura: Int,
        selectedJuz: Int
    ): List<SearchModel>
    ...
    suspend fun getJuzHezbSearchResult(
        inputSearch: String?,
        selectedJuz: Int,
    ...
    suspend fun getSuraJuzHezbSearchResult(
        inputSearch: String?,
        selectedSura: Int,
        selectedJuz: Int,
        startHezbInterval: Int,
