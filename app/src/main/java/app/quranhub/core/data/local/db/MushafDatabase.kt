...
import app.quranhub.core.data.local.dao.AyaDao
import app.quranhub.core.data.local.dao.AyaQuranSubjectDao
import app.quranhub.core.data.local.dao.HizbQuarterDao
import app.quranhub.core.data.local.dao.JuzDao
import app.quranhub.core.data.local.dao.QuranSubjectCategoryDao
import app.quranhub.core.data.local.dao.QuranSubjectDao
import app.quranhub.core.data.local.dao.SuraDao
import app.quranhub.core.data.local.db.RoomAsset.databaseBuilder
import app.quranhub.core.data.local.entity.Aya
import app.quranhub.core.data.local.entity.AyaQuranSubject
import app.quranhub.core.data.local.entity.HizbQuarter
import app.quranhub.core.data.local.entity.Juz
import app.quranhub.core.data.local.entity.QuranSubject
import app.quranhub.core.data.local.entity.QuranSubjectCategory
import app.quranhub.core.data.local.entity.Sura
