package app.quranhub.core.data.local.db
...
import app.quranhub.core.data.local.dao.BookmarkDao
import app.quranhub.core.data.local.dao.NoteDao
import app.quranhub.core.data.local.dao.QuranAudioDao
import app.quranhub.core.data.local.dao.RecitationDao
import app.quranhub.core.data.local.dao.ReciterDao
import app.quranhub.core.data.local.dao.ReciterRecitationDao
import app.quranhub.core.data.local.dao.TranslationBookDao
import app.quranhub.core.data.local.entity.AyaBookmark
import app.quranhub.core.data.local.entity.AyaRecorder
import app.quranhub.core.data.local.entity.BookmarkType
import app.quranhub.core.data.local.entity.Note
import app.quranhub.core.data.local.entity.QuranAudio
import app.quranhub.core.data.local.entity.Recitation
import app.quranhub.core.data.local.entity.Reciter
import app.quranhub.core.data.local.entity.ReciterRecitation
import app.quranhub.core.data.local.entity.TranslationBook
import app.quranhub.core.data.local.prefs.AppPreferencesManager.isDbInitialized
import app.quranhub.core.data.local.prefs.AppPreferencesManager.persistDbInitialized
