package app.quranhub.core.data.local.prefs

import android.content.Context
import app.quranhub.core.data.Constants
import app.quranhub.core.common.util.LocaleUtils.appLanguage
import app.quranhub.core.common.util.QuranPageZoom
import app.quranhub.core.data.util.SharedPrefsUtils.clearPreference
import app.quranhub.core.data.util.SharedPrefsUtils.getBoolean
import app.quranhub.core.data.util.SharedPrefsUtils.getFloat
import app.quranhub.core.data.util.SharedPrefsUtils.getInteger
import app.quranhub.core.data.util.SharedPrefsUtils.getString
import app.quranhub.core.data.util.SharedPrefsUtils.saveBoolean
import app.quranhub.core.data.util.SharedPrefsUtils.saveFloat
import app.quranhub.core.data.util.SharedPrefsUtils.saveInteger
import app.quranhub.core.data.util.SharedPrefsUtils.saveString
