package app.quranhub.core.ui.dialogs
...
import app.quranhub.core.ui.viewmodel.AudioDownloadAmountViewModel
import app.quranhub.core.common.util.DialogUtils.DIALOG_STD_WIDTH_SCREEN_RATIO_LANDSCAPE
import app.quranhub.core.common.util.DialogUtils.DIALOG_STD_WIDTH_SCREEN_RATIO_PORTRAIT
import app.quranhub.core.common.util.DialogUtils.adjustDialogSize
import app.quranhub.core.data.util.NetworkUtil.isNetworkAvailable
...
class AudioDownloadAmountDialogFragment : DialogFragment() {
    ...
    companion object {
         ...
         *
         * @param recitationId Recitation ID as in [app.quranhub.core.data.Constants.Recitation]
