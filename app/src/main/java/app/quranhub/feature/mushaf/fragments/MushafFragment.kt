...
import app.quranhub.core.data.model.ReciterModel
import app.quranhub.core.common.flowholder.DownloadFinishedHolder
import app.quranhub.databinding.FragmentMushafBinding
import app.quranhub.core.ui.dialogs.QuranRecitersDialogFragment
import app.quranhub.core.ui.dialogs.QuranRecitersDialogFragment.ReciterSelectionListener
import app.quranhub.feature.main.MainActivity
import app.quranhub.feature.mushaf.adapter.QuranViewPagerAdapter
import app.quranhub.feature.mushaf.audio_manager.AyaAudioService
import app.quranhub.feature.mushaf.audio_manager.SharedRepeatModel
import app.quranhub.feature.mushaf.dialogs.AyaAudioPopup
import app.quranhub.feature.mushaf.dialogs.AyaAudioPopup.AyaAudioListener
import app.quranhub.feature.mushaf.dialogs.AyaRecorderDialog
import app.quranhub.feature.mushaf.dialogs.AyaRecorderDialog.StopRecordingListener
import app.quranhub.feature.mushaf.dialogs.AyaRecorderPlayerDialog
import app.quranhub.feature.mushaf.dialogs.AyaRecorderPlayerDialog.AyaRecorderPlayerListener
import app.quranhub.feature.mushaf.dialogs.AyaRepeatDialogFragment.AyaRepeatListener
import app.quranhub.feature.mushaf.dialogs.AyaRepeatDialogFragment.Companion.getInstance
import app.quranhub.feature.mushaf.dialogs.TranslationsDialogFragment.Companion.newInstance
import app.quranhub.feature.mushaf.fragments.MushafBottomBarFragment.QuranFooterCallbacks
import app.quranhub.feature.mushaf.fragments.TranslationsDataFragment.TranslationSelectionListener
import app.quranhub.core.common.flowholder.AudioPlaybackState
import app.quranhub.core.common.flowholder.AudioPlaybackStateHolder
import app.quranhub.feature.mushaf.flowholder.QuranPageClickHolder
...
import app.quranhub.feature.mushaf.viewmodel.MushafViewModel
import app.quranhub.core.common.util.InsetsUtils
import app.quranhub.core.common.util.LocaleUtils.formatNumber
import app.quranhub.core.common.util.ScreenUtils.isLandscape
import app.quranhub.core.common.util.ScreenUtils.isPortrait
import app.quranhub.core.common.util.ScreenUtils.keepScreenOn
import app.quranhub.core.data.util.SharedPrefsUtils.getBoolean
import app.quranhub.core.data.util.SharedPrefsUtils.saveInteger
...
class MushafFragment : Fragment(), QuranFooterCallbacks, TranslationSelectionListener,
    ...
    private fun observeOnQuranSeekbarChange() {
        seekbarPageHandler = Handler(Looper.getMainLooper())
        seekbarPageRunnable = Runnable { _binding?.pageSeekTv?.visibility = View.GONE }
    ...
    private fun attachListeners() {
        binding.translationBottomSheet.closeBtn.setOnClickListener { onCloseTranslationDiaog() }
        binding.translationBottomSheet.tvBookName.setOnClickListener { onBookNameClicked() }
        binding.translationBottomSheet.moreBtn.setOnClickListener { onClickMore() }
        binding.translationBottomSheet.nextIv.setOnClickListener { onGetNextAyaTafseer() }
        binding.translationBottomSheet.prevIv.setOnClickListener { onClickPrevAya() }
    }
